...
Create a new database called `blackhole_user` and create a `person` table:
...
If you would like to name your database something else, you will need to change `blackhole_user` to the name of your new database name in `server/modules/pool.js`
